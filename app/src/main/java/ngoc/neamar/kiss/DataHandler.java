...
import ngoc.neamar.kiss.dataprovider.ContactsProvider;
import ngoc.neamar.kiss.dataprovider.IProvider;
import ngoc.neamar.kiss.dataprovider.Provider;
import ngoc.neamar.kiss.dataprovider.SearchProvider;
import ngoc.neamar.kiss.dataprovider.ShortcutsProvider;
import ngoc.neamar.kiss.db.DBHelper;
import ngoc.neamar.kiss.db.ShortcutRecord;
import ngoc.neamar.kiss.db.ValuedHistoryRecord;
import ngoc.neamar.kiss.pojo.Pojo;
import ngoc.neamar.kiss.pojo.PojoComparator;
...
public class DataHandler extends BroadcastReceiver
    ...
    protected Intent providerName2Intent(String name) {
        ...
        className.append("ngoc.neamar.kiss.dataprovider.");
