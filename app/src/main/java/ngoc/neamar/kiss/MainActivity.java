...
import ngoc.neamar.kiss.broadcast.IncomingCallHandler;
import ngoc.neamar.kiss.broadcast.IncomingSmsHandler;
import ngoc.neamar.kiss.dataprovider.AppProvider;
import ngoc.neamar.kiss.pojo.Pojo;
import ngoc.neamar.kiss.result.Result;
import ngoc.neamar.kiss.searcher.ApplicationsSearcher;
import ngoc.neamar.kiss.searcher.HistorySearcher;
import ngoc.neamar.kiss.searcher.NullSearcher;
import ngoc.neamar.kiss.searcher.QueryInterface;
import ngoc.neamar.kiss.searcher.QuerySearcher;
import ngoc.neamar.kiss.searcher.Searcher;
import ngoc.neamar.kiss.ui.BlockableListView;
import ngoc.neamar.kiss.ui.BottomPullEffectView;
import ngoc.neamar.kiss.ui.KeyboardScrollHider;
import ngoc.neamar.kiss.utils.PackageManagerUtils;

public class MainActivity extends Activity implements QueryInterface, KeyboardScrollHider.KeyboardHandler {

    public static final String START_LOAD = "ngoc.neamar.summon.START_LOAD";
    public static final String LOAD_OVER = "ngoc.neamar.summon.LOAD_OVER";
    public static final String FULL_LOAD_OVER = "ngoc.neamar.summon.FULL_LOAD_OVER";
    /**
