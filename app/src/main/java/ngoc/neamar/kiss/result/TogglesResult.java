...
import ngoc.neamar.kiss.pojo.TogglesPojo;
import ngoc.neamar.kiss.toggles.TogglesHandler;
...
public class TogglesResult extends Result {
    ...
    public View display(Context context, int position, View v) {
        ...
        if (v == null)
            v = inflateFromId(context, ngoc.neamar.kiss.R.layout.item_toggle);

        String togglePrefix = "<small><small>" + context.getString(ngoc.neamar.kiss.R.string.toggles_prefix) + "</small></small>";

        TextView toggleName = (TextView) v.findViewById(ngoc.neamar.kiss.R.id.item_toggle_name);
        toggleName.setText(TextUtils.concat(Html.fromHtml(togglePrefix), enrichText(togglePojo.displayName)));

        ImageView toggleIcon = (ImageView) v.findViewById(ngoc.neamar.kiss.R.id.item_toggle_icon);
        ...
        final CompoundButton toggleButton = (CompoundButton) v
                .findViewById(ngoc.neamar.kiss.R.id.item_toggle_action_toggle);
    ...
    public void doLaunch(Context context, View v) {
        if (v == null) {
            ...
            String msg = context.getResources().getString(togglesHandler.getState(togglePojo) ? ngoc.neamar.kiss.R.string.toggles_off : ngoc.neamar.kiss.R.string.toggles_on);
