package ngoc.neamar.kiss.dataprovider;
...
public interface IProvider {
     ...
     *
     * `"ngoc.neamar.summon.LOAD_OVER"` will be emitted once the reload is complete. The data provider
     ...
     * `"ngoc.neamar.summon.LOAD_OVER"` intent for notification of when the provider is ready.
     *
